<template>
  <div class="flex flex-row p-2 h-[calc(100vh-80px)]">
    <div class="flex flex-col justify-between gap-5 w-2/5">
      ...
      <div>
        <p class="text-5xl text-slate-900 font-semibold">Local Civil Registry</p>
        <p class="text-2xl text-slate-800 font-sans">Bayambang, Pangasinan</p>
      </div>
      <div>
        <p class="text-lg text-slate-800 font-bold">ISMAEL D. MALICDEM, JR</p>
        <p class="text-lg text-gray-500 font-semibold">MUNICIPAL CIVIL REGISTRAR</p>
      </div>
      <div class="mt-auto">
        <p class="text-md text-slate-800 font-bold">
