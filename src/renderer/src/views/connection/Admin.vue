        ...
        <div class="flex flex-col bg-gray-100 h-full w-full justify-center items-center gap-4">
            ...
            <div class="flex flex-row   gap-2 mt-auto items-center justify-center w-full p-4 ">
                <button @click="resetMode()" type="button"
                    class="flex items-center py-2 px-4 me-2 mb-2 mr-auto text-sm font-medium  text-gray-900 focus:outline-none bg-gray-50 rounded-sm border border-gray-300 hover:bg-gray-100 focus:z-10   dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
...
const resetMode = () => {
    if (server.getStatus) {
        Toast.fire({
            icon: "error",
            title: "You must turn off the server first",
        });
        return
    }
    mode.resetMode()
