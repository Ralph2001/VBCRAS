<template>
    <div
        class="flex flex-col h-full justify-center items-center bg-[#FFFFFF] relative overflow-y-scroll"
    >
        ...
        <div class="flex flex-col items-center">
            ...
            <div
                class="ml-auto flex items-center w-[20rem] justify-between mt-10"
            >
                <router-link
                    to="/"
                    class="text-gray-900 border-black h-6 hover:text-blue-500"
                >
