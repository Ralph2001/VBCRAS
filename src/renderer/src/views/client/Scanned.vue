...
<template>
    <div
        class="flex flex-col relative justify-center w-full"
    ...
    >
                ...
                >
                    <div class="flex flex-row items-center">
                        <svg
                            aria-hidden="true"
                            role="status"
                            class="inline w-4 h-4 me-2 text-gray-900 animate-spin"
                            viewBox="0 0 100 101"
                            fill="none"
        ...
        <DropZone
            v-if="dropzone && !auth.user_details.permissions.scanned_add"
                ...
                <div class="flex flex-col gap-2 py-2">
                    ...
                    <div class="flex md:flex-row flex-col gap-2 mt-3">
                        <Dropdown
                            label="Month"
                            :optionData="months"
                            v-model="scannedData.month"
                            :error="v$.month.$error"
                        />
                        <Dropdown
                            label="Year"
                            :optionData="years"
                            v-model="scannedData.year"
                            :error="v$.year.$error"
                        />
                    </div>
                </div>
        ...
        <!-- Footer -->
        <div
            class="pr-10 h-auto flex flex-row bottom-0 fixed w-full left-0 p-2 justify-between items-center mx-auto"
        >
            <div class="flex flex-row items-center gap-2">
                <button
                    class="rounded-full py-2 px-3 text-gray-500 active:bg-gray-200 hover:bg-gray-200"
            ...
            <p
                class="text-sm font-medium text-gray-900 select-all"
                v-if="!Documents.viewMode"
            >
