...
<template>
  <div class="flex flex-col h-[calc(100vh-190px)] relative w-full">
    ...
    >
      <div
        class="flex flex-col md:basis-[35%] items-center h-full justify-center gap-10 px-10"
      >
        ...
        <div class="">
          <p
            class="text-md font-normal text-justify leading-7 tracking-wider text-gray-800"
          >
    ...
    <div
      class="fixed flex flex-row sm:gap-5 md:gap-[5rem] bottom-0 right-0 left-0 px-10 py-2 bg-slate-50"
    >
      <div class="flex md:flex-row lg:flex-row sm:flex-col sm:gap-2 md:gap-[5rem]">
        <div>
          <p
            class="text-sm text-slate-800 font-bold text-nowrap antialiased tracking-widest"
          >
      ...
      <div class="flex items-center sm:justify-end w-full md:ml-auto gap-2">
        <img
          src="../../assets/bayambang_logo.png"
          class="h-14 animate__animated animate__tada"
          alt=""
          srcset=""
        />
        <div class="flex-col items-center">
          ...
          <p
            class="text-sm text-gray-600 font-semibold antialiased text-nowrap tracking-widest"
          >
