<template>
    <div class="flex flex-col relative justify-center w-full p-10">
        ...
        <!-- For Viewing -->
        <FormModal
            :title="`View Document - ${documentOwner}`"
            v-if="isViewLocalOpen"
        ...
        >
            <template v-slot:control>
                ...
                >
                    <div class="ml-auto flex flex-row gap-2">
                        <PrintManager
                            :active_pdf_link="localPdf"
                            :active_pdf="''"
                            :count="localViewCount"
                        />
                        <button
            ...
            <template v-slot:content>
                <div class="w-full h-full">
                    <div
                        class="fixed inset-0 z-50 bg-black/20 backdrop-blur-sm p-4 justify-center items-center flex"
                    >
                        <!-- Document Properties Panel -->
                        <div
                            class="max-w-md bg-white h-auto p-2 flex flex-col w-full rounded-lg shadow-lg p-4 gap-4"
                        >
                    ...
                    <PDFViewerWorker
                        :scale="1.5"
                        :pdfBytes64="localPdf"
                        @update:pdfBytes64="previewUrl = $event"
                    />
                </div>
            </template>
        </FormModal>
        ...
        <FormModal
            :title="`Create New Form ${selectedType}`"
            v-if="isFormOpen"
        ...
        >
            ...
            <template v-slot:content>
                ...
                >
                    <div class="w-full grid grid-cols-1 max-w-screen-lg py-1.5">
                        ...
                        >
                            ...
                            >
                                ...
                                <p
                                    class="mt-4 text-sm text-gray-700 leading-relaxed"
                                >
                                    You have unsaved changes in the form.
                                    Closing this window now will
                                    <span class="font-medium text-red-500"
                                        >discard all entered data</span
                                    >. If you'd like to keep your information,
                                ...
                                <div class="mt-6 flex justify-end gap-2">
                                    ...
                                    <button
                                        @click="unsavedDataMessage = false"
                        ...
                        <div class="flex flex-col gap-1 px-4 py-4">
                            <div class="flex items-center justify-end">
                                <div class="w-[15rem]">
                                    <InputforForm
                                        middle
                                        width="full"
                                        v-model="transactions.date_filed"
                                    />
                                </div>
                            </div>
                            <p
                                class="px-9 italic font-semibold font-serif text-sm"
                            >
                            ...
                            <div
                                ...
                                v-if="selectedType.includes('A')"
                            >
                                <div
                                    class="text-sm w-full my-auto mb-6 flex justify-center"
                                >
                                    <p
                                        class="relative text-pretty tracking-widest indent-8 leading-8 text-neutral-900"
                                    >
                                        We certify that among others, the
                                        following facts of {{ fact_of }} appear
                                        in our Register of <br />{{
                                            register_of
                                        }}
                                        on page
                                        <InputforForm
                                ...
                                <div
                                    v-if="selectedType === '3A'"
                                    class="flex flex-col mt-4 gap-2 w-full"
                                >
                                    <InputLabel label="Name" twoInput>
                                        :
                                        <InputforForm
                                            width="100%"
                                            v-model="Form3A.groom_name"
                                        />
                                        :
                                        <InputforForm
                                            width="100%"
                                            v-model="Form3A.bride_name"
                                        />
                                    </InputLabel>
                                    <InputLabel label="Age" twoInput>
                                        ...
                                        <InputforForm
                                            width="100%"
                                            v-model="Form3A.groom_age"
                                        />
                                        :
                                        <InputforForm
                                            width="100%"
                                            v-model="Form3A.bride_age"
                                        />
                                    </InputLabel>
                                    ...
                                    <InputLabel label="Citizenship" twoInput>
                                        ...
                                        <InputforForm
                                            width="100%"
                                            v-model="Form3A.groom_citizenship"
                                        />
                                        :
                                        <InputforForm
                                            width="100%"
                                            v-model="Form3A.bride_citizenship"
                                        />
                                    </InputLabel>
                                    ...
                                    <InputLabel label="Civil Status" twoInput>
                                        ...
                                        <InputforForm
                                            width="100%"
                                            v-model="Form3A.groom_civil_status"
                                        />
                                        :
                                        <InputforForm
                                            width="100%"
                                            v-model="Form3A.bride_civil_status"
                                        />
                                    </InputLabel>
                                    <InputLabel label="Mother" twoInput>
                                        ...
                                        <InputforForm
                                            width="100%"
                                            v-model="Form3A.groom_mother"
                                        />
                                        :
                                        <InputforForm
                                            width="100%"
                                            v-model="Form3A.bride_mother"
                                        />
                                    </InputLabel>
                                    ...
                                    <InputLabel label="Father" twoInput>
                                        ...
                                        <InputforForm
                                            width="100%"
                                            v-model="Form3A.groom_father"
                                        />
                                        :
                                        <InputforForm
                                            width="100%"
                                            v-model="Form3A.bride_father"
                                        />
                                    </InputLabel>
                                </div>
                                ...
                                <div class="flex flex-col gap-2">
                                    <InputLabel label="Registry Number">
                                        ...
                                        <InputforForm
                                            width="100%"
                                            v-model="available.registry_number"
                                        />
                                    </InputLabel>

                                    <InputLabel
                                        label="Date of Registration"
                                        :error="isRegistrationValid"
                                    >
                                        :
                                        <InputforForm
                                            width="100%"
                                            v-model="
                                                available.date_registration
                                            "
                                        />
                                    </InputLabel>
                                </div>
                                ...
                                <div
                                    v-if="selectedType === '3A'"
                                    class="flex flex-col gap-2 mb-auto"
                                >
                                    <InputLabel label="Date of Marriage">
                                        :
                                        <InputforForm
                                            width="100%"
                                            v-model="Form3A.date_marriage"
                                        />
                                    </InputLabel>
                                ...
                                <!-- For Form 1A -->
                                <div
                                    v-if="selectedType === '1A'"
                                    class="flex flex-col mb-auto gap-2"
                                >
                                    ...
                                    <InputLabel label="Citizenship of Mother">
                                        ...
                                        <InputforFormSuggestions
                                            width="100%"
                                            v-model="Form1A.citizenship_mother"
                                    ...
                                    <InputLabel label="Citizenship of Father">
                                        ...
                                        <InputforFormSuggestions
                                            width="100%"
                                            v-model="Form1A.citizenship_father"
                                            :options="citizenshipOptions"
                                        />
                                    </InputLabel>
                                    <InputLabel label="Date of Marriage">
                            ...
                            <!-- Forms with `B` -->
                            <div
                                class="flex flex-col gap-2 mt-auto mb-auto"
                                v-if="selectedType.includes('B')"
                            >
                                <div class="mt-10 px-10">
                                    <p
                                        class="indent-8 text-pretty leading-10 tracking-wider text-justify"
                                    >
                                        We certify that this office has no
                                        record of
                                        {{
                                            selectedType === '1B'
                                                ? 'birth'
                                        ...
                                        <InputforForm
                                            ...
                                            bold
                                            middle
                                            v-model="intact_date_field"
                                        />
                                        in this municipality,

                                        <!-- If Form 1B -->
                                        <span v-if="selectedType === '1B'">
                                            of parents
                                            <InputforForm
                                                width="18rem"
                                                bold
                                                middle
                                                v-model="Form1B.father_name"
                                                v-if="selectedType === '1B'"
                                            />
                                            and
                                            <InputforForm
                                                width="18rem"
                                                bold
                                                v-model="Form1B.mother_name"
                                                v-if="selectedType === '1B'"
                                                middle
                                            />.
                                        </span>

                                        Hence, we cannot issue, as requested, a
                                        true copy of his/her Certificate of
                                        {{
                                            selectedType === '1B'
                                                ? 'Live Birth'
                                                : selectedType === '2B'
                                        ...
                                        or transcription from the Register of
                                        {{
                                            selectedType === '1B'
                                                ? 'Births'
                                                : selectedType === '2B'
                                ...
                                <div class="mt-10 px-10">
                                    <p
                                        class="indent-8 text-pretty tracking-wider text-justify"
                                    >
                                        We also certify that the records of
                                        {{ records_of }} for the year
                                        <InputforForm
                                            width="6rem"
                                            bold
                                            middle
                                            v-model="intact_year_field"
                                        />
                                        are still intact in the archives of this
                                        office.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div
                                class="flex flex-col gap-2 mt-auto mb-auto"
                                v-if="selectedType.includes('C')"
                            >
                                <p
                                    class="indent-8 text-pretty leading-10 tracking-wider text-justify"
                                >
                                    We certify that the records of
                                    {{ records_of }}
                                    filed in the archives of this office include
                                    those, which were registered from
                                    <InputforForm
                                        width="6rem"
                                        middle
                                        v-model="destroyed.registered_from"
                                    />
                                    to present. However, the records of
                                    {{ records_of }} during period
                                    <InputforForm
                                        middle
                                        width="6rem"
                                        v-model="destroyed.from_year"
                                    />
                                    to
                                    <InputforForm
                                        middle
                                        width="6rem"
                                        v-model="destroyed.to_year"
                                    />
                                    were totally destroyed by
                                    <InputforForm
                                        middle
                                        width="20rem"
                                        v-model="destroyed.destroyed_by"
                                    />
                                    Hence, we cannot issue as requested, a true
                                    transcription from the Register of
                                    {{ register_of }} or true copy of the
                                    Certification of {{ register_of }} of
                                    <InputforForm
                                        middle
                                        width="25rem"
                                        v-if="
                                    ...
                                    <span v-if="selectedType === '3C'">
                                        <InputforForm
                                            middle
                                            width="25rem"
                                            v-model="Form3C.groom_name"
                                        />
                                        and
                                        <InputforForm
                                            middle
                                            width="25rem"
                                            v-model="Form3C.bride_name"
                                        />
                                    </span>
                                    who is alleged to have {{ alleged_to }} on
                                    <InputforForm
                                        middle
                                        width="10rem"
                                        v-model="destroyed_date_field"
                                    />
                                    in this municipality
                                    <span v-if="selectedType === '1C'"
                                        >of parents
                                        <InputforForm
                                            middle
                                            width="25rem"
                                            v-model="Form1C.father_name"
                                        />
                                        and
                                        <InputforForm
                                            middle
                                            width="25rem"
                                            v-model="Form1C.mother_name"
                                        /> </span
                                    >.
                                </p>
                            </div>
                        ...
                        <div class="flex flex-col gap-2 px-4 py-4">
                            ...
                            >
                                ...
                                <div class="px-2">
                                    <InputforForm
                                        ...
                                        bold
                                        v-model="
                                            transactions.certification_issued_to
                                        "
                                    />
                                </div>
                            ...
                            <div
                                ...
                                v-if="is_with_remarks"
                            >
                                <div class="flex flex-row gap-2 items-center">
                                    <input
                                        type="checkbox"
                                        v-model="available.is_reconstructed"
                                        class="border rounded-sm border-gray-400"
                                        id="is_reconstructed"
                                    />
                                    <label
                                        class="text-md font-medium text-neutral-800 text-sm"
                                        for="is_reconstructed"
                                        >Reconstructed Copy</label
                                    >
                                </div>
                                ...
                                <div class="flex flex-row gap-2 items-center">
                                    <input
                                        type="checkbox"
                                        v-model="available.is_other_remarks"
                                        class="border rounded-sm border-gray-400"
                                        id="is_other_remarks"
                                    />
                                    <label
                                        class="text-md font-medium text-neutral-800 text-sm"
                                        for="is_other_remarks"
                                        >Other Remarks</label
                                    >
                                </div>
                                ...
                                <div
                                    class="flex flex-col py-2 w-full gap-2"
                                    v-show="available.is_other_remarks"
                                >
                                    <div
                                        class="w-full flex flex-col gap-1 bg-white"
                                    >
                                        <QuillEditor
                                            @ready="handleEditorReady"
                                            theme="snow"
                                            :toolbar="['bold', 'italic']"
                                            v-model:content="available.remarks"
                                            contentType="delta"
                                            content="delta"
                                        />
                                        <!-- {{ available.remarks }} -->
                            ...
                            <div
                                class="mt-auto grid grid-cols-2 gap-4 mb-4 h-44 items-center"
                            >
                                <div class="flex flex-col">
                                    <p class="italic mb-10">Verified by:</p>
                                    <div
                                        class="pl-0 flex flex-col items-center gap-[0.10rem]"
                                    >
                                        <InputforForm
                                            skip
                                            width="100%"
                                            bold
                                            middle
                                            v-model="transactions.verified_by"
                                            isUpperCase
                                        />
                                        <InputforForm
                                            skip
                                            ...
                                            unbordered
                                            v-model="
                                                transactions.verifier_position
                                            "
                                        />
                                    </div>
                                </div>
                                <transition name="fade-scale">
                                    <div
                                        class="flex flex-col items-center gap-[0.10rem]"
                                    >
                                        <p
                                            v-if="
                                                transactions.for_and_in_the_absence
                                            "
                                        ...
                                        <InputforForm
                                            ...
                                            unbordered
                                            v-model="
                                                transactions.civil_registrar_position
                                            "
                                        />
                                        <div
                                            v-if="
                            ...
                            <div class="flex flex-col gap-2 w-[60%]">
                                <InputLabel label="Amount Paid ">
                                    <InputforForm
                                        width="100%"
                                        v-model="transactions.amount_paid"
                                        skip
                                    />
                                </InputLabel>
                                ...
                                <InputLabel label="O.R. Number">
                                    <InputforForm
                                        width="100%"
                                        v-model="transactions.or_number"
                                    />
                                </InputLabel>
                                <InputLabel label="Date Paid">
                                    <InputforForm
                                        width="100%"
                                        v-model="transactions.date_paid"
                                    />
                                </InputLabel>
                            </div>
                        </div>
                    ...
                    <div
                        class="w-full flex mt-10 items-center justify-center bg-gray-100"
                    >
                        <div
                            class="max-w-screen-lg flex flex-row gap-2 p-4 w-full"
                        >
                            <div class="flex flex-col gap-1">
                                <div class="flex flex-row gap-2 items-center">
                                    <input
                                        type="checkbox"
                                        v-model="
                                            transactions.is_with_authentication
                                        "
                                        name=""
                                    ...
                                    />
                                    <label
                                        for="with_authentication"
                                        class="text-md font-medium text-neutral-800"
                                ...
                                <div class="flex flex-row gap-2 items-center">
                                    <input
                                        ...
                                        "
                                        type="checkbox"
                                        id="for_and_in_the_absence"
                                        class="border rounded border-gray-400"
                                    />
                                    <label
                                        for="for_and_in_the_absence"
                                        class="text-md font-medium text-neutral-800"
                ...
                <div v-else class="h-full w-full bg-gray-50 flex">
                    ...
                    >
                        ...
                        >
                            <div
                                v-for="(section, sectionKey) in preference"
                                :key="sectionKey"
                                class="p-4"
                            >
                                <h3
                                    class="text-sm font-medium text-gray-700 mb-3 capitalize"
                                >
...
const isValidDate = (str) => {
    ...
    const [inputDay, inputMonth, inputYear] = parsed
        .toDateString()
        .split(' ')
        .slice(1)
...
const isRegistrationValid = computed(() => {
    ...
    if (
        !isValidDate(form[eventField]) ||
        !isValidDate(available.date_registration)
    ) {
...
const saveForm = async () => {
    ...
    const documentOwner = (() => {
        switch (form_type) {
            case '1A':
                return Form1A.name_child
            case '1B':
                return Form1B.no_record_birth_of
            case '2A':
                return Form2A.name_deceased
            case '2B':
                return Form2B.no_record_death_of
            case '3A':
                return `${Form3A.groom_name} & ${Form3A.bride_name}`
            case '3B':
                return `${Form3B.no_record_marriage_of} & ${Form3B.married_with}`
            case '1C':
                return Form1C.birth_name
            case '2C':
                return Form2C.death_name
            case '3C':
                return `${Form3C.groom_name} & ${Form3C.bride_name}`
            default:
                return ''
        }
    })()
    ...
    if (formID.value && isUpdateHook.value) {
        await formsStore[`edit_form${form_type.toLowerCase()}`](
            formID.value,
            formData
        )
    } else {
...
const previewForm = async () => {
    ...
    if (formAvailableMapping[form_type]) {
        ...
        const preview = await window.FormApi.PreviewFormPDF(
            JSON.stringify(main_data)
        )
...
const options = ref(['Form 1 (Birth)', 'Form 2 (Death)', 'Form 3 (Marriage)'])
...
const columnPresets = {
    ...
    'Birth Intact': [
        {
            field: 'no_record_birth_of',
            headerName: 'No Record Birth Of',
            flex: 2
        },
    ...
    'Death Intact': [
        {
            field: 'no_record_death_of',
            headerName: 'No Record Death Of',
            flex: 1,
            pinned: 'left'
        },
    ...
    'Marriage Intact': [
        {
            field: 'no_record_marriage_of',
            headerName: 'No Record Marriage Of',
            flex: 1,
            pinned: 'left'
        },
