<template>
    <div class="flex flex-col items-center justify-center h-full relative">
        ...
        <p class="text-2xl text-gray-900 font-medium  font-sans">Server Panel</p>
        ...
        <div class=" flex flex-col items-center">
            <InputField label="Server Key" type="password" v-model="formData.key" :error="v$.key.$error"
                @keyup.enter="login()">
                <p v-if="v$.key.$error" class="mt-2 text-sm text-red-600 dark:text-red-500"><span
                        class="font-medium">Error!</span> {{ v$.key.$errors[0].$message }}</p>
            </InputField>
