<template>
  <div class="flex items-center gap-2" v-for="(value, key) in options" :key="key">
    ...
    <button @focus="scrollToView" @keydown.down="focusNextInput" @keydown.up="focusPreviousInput"
      @keydown.right="focusNextInput" @keydown.left="focusPreviousInput" @click="select_this(key)"
