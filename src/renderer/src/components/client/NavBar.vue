<template>
    <div>
        ...
        >
            <div
                class="w-full flex flex-wrap items-center justify-between mx-auto p-4 relative"
            >
                <a
                    href="#"
                ...
                >
                    <img
                        src="../../assets/logo.png"
                        class="h-12"
                        alt="Local Civil Registry"
                    />
                    <span
                        class="self-center text-lg text-gray-800 font-semibold whitespace-nowrap dark:text-white"
                        >VBCRAS</span
                    >
                </a>
                <button
                ...
                <div
                    class="hidden w-full md:block md:w-auto absolute top-[3.5rem] md:static md:top-0"
                    id="navbar-dropdown"
                >
                    <ul
                    ...
                    >
                        ...
                        <li>
                            ...
                            >
                                CCE & CFN
                                <span
                                    class="text-[0.60rem] font-base tracking-tight"
                                >
