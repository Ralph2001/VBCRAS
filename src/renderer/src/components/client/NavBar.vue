    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
      <div class="w-full flex flex-wrap items-center justify-between mx-auto p-4 relative">
        <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <span class="self-center text-lg text-gray-800 font-semibold whitespace-nowrap dark:text-white">VBCRAS</span>
        </a>
        ...
        <div :class="{ hidden: !dropdown }" ref="menu"
