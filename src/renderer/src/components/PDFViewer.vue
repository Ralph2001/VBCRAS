<template>
    <div class="h-full w-full fixed top-0 bottom-0 right-0 left-0 bg-white items-center flex justify-center z-[99999]">
        <div class="w-full flex  absolute  p-4 top-0 z-[99999]">
        ...
        <div
            class="absolute sm:w-[1.5rem] md:lg:w-[2rem] top-0 bottom-0 block right-0 bg-[#525659] z-[99998]   items-center justify-center h-full">
            <!-- <button v-if="!status"
        ...
        <div class="absolute right-0 left-0 bottom-0 -top-16">
