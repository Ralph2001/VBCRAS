<template>
    ...
    <div
        ...
        <div class=" h-auto w-[50rem] rounded-md border shadow  bg-white p-7 flex flex-col gap-2">
            ...
            <p class="text-justify text-gray-900 font-normal text-sm">Before you continue, please check the layout and design of
            ...
            <p class="text-justify text-sm text-gray-900 font-normal ">
                <span class="font-medium text-md ">Please Note:</span> <br> Any changes you make in the document
                won’t
            ...
            <div class="mt-auto flex flex-row items-center gap-1">
                <button type="button" @click="cancel_btn"
                    class="ml-auto border rounded border-gray-300 px-3 py-1.5 hover:bg-gray-200 text-sm outline-none ring-0">Return
                    to Form Editor </button>
                <button type="button" @click="proceed"
                    class="border rounded border-gray-300 px-3 py-1.5 bg-blue-500 text-white hover:bg-blue-600 text-sm">Proceed</button>
            </div>
        </div>
    </div>
</template>
