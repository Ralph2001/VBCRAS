<template>
  <nav class="sm:bg-white sm:z-50 md:z-0 md:bg-none border-gray-200 dark:bg-gray-900 dark:border-gray-700 h-16 ">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="sm:bg-white sm:z-50 md:z-0 hidden w-full md:block md:w-auto" id="navbar-dropdown">
        <ul
          class=" flex sm:bg-white sm:z-50 md:z-0 md:bg-none flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
