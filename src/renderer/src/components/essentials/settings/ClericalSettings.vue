            ...
            <div class="h-full">
                <div class="flex flex-col gap-2 p-2">
                    <div class="flex items-center w-full justify-center">
                        <div
                            class="flex flex-row flex-wrap w-fit divide-x border divide-gray-200 shadow-sm"
                        >
                            <Button
                                label="Default Values"
                                :isActive="defaultValues"
                                @click="tabOpen('defaultValues')"
                            />
                            <Button
                                label="Date Settings"
                                :isActive="datePosting"
                                @click="tabOpen('datePosting')"
                            />
                            <Button
                                label="File Location"
                                :isActive="fileLocation"
                                @click="tabOpen('file')"
                            />
                        </div>
                    </div>
                ...
                <div
                    class="flex flex-col w-full mt-5 gap-6 p-2"
                    v-if="defaultValues"
                >
                ...
                <div
                    class="flex flex-col items-center justify-center w-full mt-5 gap-6 p-2"
                    v-if="datePosting"
                >
                ...
                >
                    <div class="flex flex-col gap-3 w-full">
                        <p
                            class="font-semibold text-md tracking-wide text-blue-500"
                        >
                            File Location
                        </p>
