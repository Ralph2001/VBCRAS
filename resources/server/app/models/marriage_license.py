...
class Ausf(db.Model):
     ...
     groom_person_who_gave_consent_residence_country = db.Column(db.String, nullable=True)
     ...
     bride_person_who_gave_consent_residence_country = db.Column(db.String, nullable=True) 
